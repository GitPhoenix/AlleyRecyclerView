...
public class AlleySwipeRecyclerView extends AlleyRecyclerView {
    ...
    public AlleySwipeRecyclerView(Context context) {
        this(context, null);
    }

    public AlleySwipeRecyclerView(Context context, AttributeSet attrs) {
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (view instanceof AlleySwipeLayout) {
                    mTouchView = (AlleySwipeLayout) view;
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (isOutDuration || isOutX || isOutY) {
                    ...
                    if (upView instanceof AlleySwipeLayout) {
                        AlleySwipeLayout smView = (AlleySwipeLayout) upView;
