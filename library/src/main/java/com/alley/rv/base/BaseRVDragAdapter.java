...
public abstract class BaseRVDragAdapter<T> extends BaseRVAdapter<T> {
    ...
    public BaseRVDragAdapter(Context context, List<T> data) {
        super(context, data);
    }
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled ) {
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                ...
                if (toggleView != null) {
                    toggleView.setTag(R.id.recycler_drag_support_toggle, holder);
                    if (mDragOnLongPress) {
                ...
                holder.itemView.setTag(R.id.recycler_drag_support_toggle, holder);
        ...
        if (mDragOnLongPress) {
            ...
            mOnToggleViewLongClickListener = new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mItemTouchHelper != null && itemDragEnabled) {
                        mItemTouchHelper.startDrag((RecyclerView.ViewHolder) v.getTag(R.id.recycler_drag_support_toggle));
                    }
                    return true;
                }
            };
